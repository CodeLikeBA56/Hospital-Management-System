...
<body>
    ...
    <header>PATIENT BILLS</header>
    <?php
        include('../DatabaseConnection.php');
        session_start();

        $sql = "SELECT p.patient_name, p.patient_id, p.patient_age, p.patient_gender,
        b.number_of_days, b.doctor_fee, b.lab_fee, b.food_charges, b.medicine_fee, b.room_charges,
        b.icu_cost, b.theatre_fee, b.surgeon_fee, b.other_expenses
        FROM patient p JOIN generatebill gb ON(p.patient_id = gb.patient_id) 
        JOIN bill b ON(gb.bill_id = b.bill_id) WHERE p.patient_care_id = $_SESSION[User]";
        ...
        if ($_result->num_rows > 0) {
            ...
            while($_row = $_result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td>".$_row['doctor_fee']."</td>
                    <td>".$_row['lab_fee']."</td>
                    <td>".$_row['food_charges']."</td>
                    <td>".$_row['medicine_fee']."</td>
